...
int main(int argc, char **argv){
  ...
  auto defend_behavior_ptr = std::make_shared<rrts::decision::DefendBehavior>(blackboard_ptr, planner_behavior_ptr);
  auto depart_behavior_ptr = std::make_shared<rrts::decision::DepartBehavior>(blackboard_ptr, planner_behavior_ptr);
  auto occupy_behavior_ptr = std::make_shared<rrts::decision::OccupyBehavior>(blackboard_ptr, planner_behavior_ptr);
  auto monitor_behavior_ptr = std::make_shared<rrts::decision::MonitorBehavior>(blackboard_ptr, planner_behavior_ptr);
  ...
  selector_ptr->AddChildren(defend_behavior_ptr);
  selector_ptr->AddChildren(depart_behavior_ptr);
  selector_ptr->AddChildren(occupy_behavior_ptr);
  selector_ptr->AddChildren(monitor_behavior_ptr);
